	...
	<div id="wrapper">
		...
		<ul
			...
			<li class="nav-item active"><a class="nav-link"
				href="../resources/main.html"> <i class="fas fa-fw fa-tachometer-alt"></i> <span>Dashboard</span></a>
			</li>
			...
			<!-- Nav Item - Tables -->
			<li class="nav-item"><a class="nav-link" href="../resources/tables.html">
